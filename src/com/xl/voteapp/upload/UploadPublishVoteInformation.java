...
public class UploadPublishVoteInformation {
	public static boolean save(int uno, String vtitle,String vcontent, List<Item> optionlist,String u_name) throws Exception{
	//	String path = "http://192.168.191.1:8080/votefinalserver150310/PublishVote";		
		String path = Contanst.URLPATH+"PublishVote";
        Vote v=new Vote(0, vtitle, vcontent, uno, 0, null, u_name,optionlist );	
