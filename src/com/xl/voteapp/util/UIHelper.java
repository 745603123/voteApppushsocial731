...
public class UIHelper {
     ...
     * @param blogId
     */
    public static void showPublishVoteActivity(Context context, int uno,String u_name) {
    ...
    public static void showVoteActivity(Context context, int v_id,String v_title,String content,ArrayList<Item> optionlist) {
