...
//	public static final String URLPATH="http://votesysapp.duapp.com/";
	public static final String URLPATH="http://192.168.191.1:8080/votefinalserver150310/";
	
	public static final String PROP_KEY_UNO = "user.u_no";
	public static final String PROP_KEY_UNAME = "user.u_name";
	public static final String PROP_KEY_UPWD = "user.u_pwd";
	public static final String ROP_KEY_UEMAIL = "user.u_email";
	public static final String ROP_KEY_UTEL = "user.u_tel";
